...
The aim of this project is to use TensorFlow to process our own data.
 ...
 I used Ubuntu with Python 3.6, TensorFlow 1.0*, other OS should also be good.
...
def run_training():
    ...
    logs_train_dir = 'C:/Users/俊松/Documents/我的工作区/My-TensorFlow-tutorials-master/01.cats_vs_dogs/logs/'
